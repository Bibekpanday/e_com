...
<div class="header-1">
    ...
    <a href="index.php" class="logo" > <img src="website/all/Hamrobazar-Logo.jpg" alt="Hamrobazar-Logo" class="hidden-xs">  </a>
...
<nav class="navbar"> 
     ...
     <ul >
        <li>
            ...
            <li><a href="#arrival">Electronic</a></li>
            <li><a href="#cloths">Clothes</a></li>
...
<h1 class="heading"> <span>Cream</span> </h1>
  ...
  <footer class="footer" id="footer">
     <div class="cuntainer">
        <div class="wolf">
            ...
            <p class="credit">Copyright &copy; <span>2024-2025</span> | all rights reserved. | <span>Designed Ranjit yadav</span></p>
        </div>
     </div>
  </footer>
